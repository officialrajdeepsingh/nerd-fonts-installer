...
## Install Nerd fonts demo
![DEMO](./media/videos/install-nerd-font.gif "install nerd font demo")
...
| `--nerd-fonts-version=v3.4.0` | `NERD_FONTS_VERSION=v3.4.0` | Pin a specific release |
